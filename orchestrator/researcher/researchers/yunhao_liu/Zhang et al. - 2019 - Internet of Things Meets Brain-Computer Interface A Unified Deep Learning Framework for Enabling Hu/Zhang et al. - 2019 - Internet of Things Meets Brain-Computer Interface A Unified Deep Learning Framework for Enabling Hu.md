...
![](images/c89343d6d22fea4805a14bfa5882a9981f002321f8dd0c510f7d524efe692583.jpg)
...
![](images/ebf037e2ad96d134bbb58be8fa0c10780268efc2d09b164b773c36c3d0cf86f4.jpg)
...
random  is suffic $\mathbf { x } _ { i } ^ { \prime } = [ 3 , 5 , 8 , 9 , 2 , 1 , 6 , 0 ] ,$ the sone as $\Omega s t a r t _ { i d x } ^ { t } =$ $2 , e n d _ { i d x } ^ { t } = 5 \}$ $[ 8 , 9 , 2 , 1 ]$
...
![](images/eab050efcd9cb2f6d42e1e82c2781cf0382f165e1848d7dc7451628e9101a51e.jpg)



(a)

![](images/32f0154760fcabfc0d31df01f53dfb5cab6fb9d38da8b2ead55db58c6fca292e.jpg)
...
![](images/a1ba662696a37a5ae72e19adae388369dfd30cd462929abbcdab3e7dfda3c31a.jpg)



(a)

![](images/d386bc71d210d0feaa04699ac2487ebdbf76cbd12469927e411f69c500614245.jpg)



(b)

![](images/c66a8de29771a6d1ba3e332dbf66640c8011536baec82673a99fd62989b17746.jpg)
...
In the training stage, based on the tuning experience, the hyperparameters setting are listed as follows. In the selective attention learning: the order of autoregressive is 3; $ \bar { K } = 1 2 8$ , the Dueling DQN has 4 layers and the node number in each layer are: 2 (input layer), 32 (FCL), $\mathrm { ~ 4 ~ } ( A \big ( s _ { t } , a _ { t } \big ) ) + \mathrm { ~ 1 ~ } ( V \big ( s _ { t } \big ) )$ , 4 (output). The decay parameter $\gamma = 0 . 8 , n _ { e } = n _ { s } = 5 0 , N = 2 , 5 0 0$ , $\epsilon \ = \ 0 . 2 .$ , learning rate= 0.01, memory size = 2000, length penalty coefficient $\beta \ : = \ : 0 . 1$ , and the minimum length of focal zone is set as 10. In the deep learning classifier: the node number in the input layer equals to the number of feature dimensions, three hidden layers with 164 nodes, two layers of LSTM cells (164 cells) and one output layer (6 nodes). The learning rate = 0.001, \`2-norm coefficient $\lambda = 0 . 0 0 1$ , forget bias = 0.3, batch size = 9, and iterate for 1000 iterations.
...
![](images/8da7d6826f654892f3eca2640fae18529754f7c34789f3a255e86475378251c8.jpg)
...
![](images/ec0cac44dc4e9b75355d9f7746eabbe47f95d428c94df74fe19cf3c7318750be.jpg)
...
![](images/b81b329f64eed3758dd3b269c90987aa3df886c9608390a0142e1d868ac8e751.jpg)



![](images/9b09022f0c1c79a8d895bf7058e6ff35062a2983faf9da25dd52565ffee2f793.jpg)
...
Gazebo toolbox and the robot controlling program is powered by Robot Operating System (ROS). This case randomly selects some EEG raw data from Subject 1 dataset as simulation inputs.
...
![](images/5945951d5b90788f6b1d749e35c69a53ea219799f1d944d5b1d924ca8f560469.jpg)



![](images/c7b4bc6985a3ef7074cf27d5a23a6464ac228ed2aebaad38770a6146eeee9132.jpg)



![](images/ee0dbe8e72bf67f029a757200cfcace69e3d53a3b1a1a7e4e6eb00c6f0f12e95.jpg)



![](images/e4fdcb34ec51ca71f4bea05d3096914c7d93c78138f7fb4d3363ad9413b8a4f4.jpg)



![](images/9775912c8a698f6002e416fec1b0c30074079fde66404e8c3a22393c02197c82.jpg)



![](images/4051a39475e6c2959dd27a61e2a480610c2452229f94fe7456d67c088644aa4b.jpg)
