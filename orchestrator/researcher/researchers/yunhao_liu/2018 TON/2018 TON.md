...
![](images/04575d47dd3514efc796510f041a4651ee0164f7827bcfac51ad8254950b366f.jpg)



(a) Fixed feature space size n.

![](images/fd6075a94930bc243dd348642c977dc1907570a36faed9046bbfac483f75a7c2.jpg)

![](images/e8aad067308400043c4a34080557116d3c60a4d507db9178edc3e0787948039f.jpg)
...
![](images/6d0ee5b315cf87a602216aad1b2ae6a305d97b9868498a365d09004dc5576aa1.jpg)  
(a) Fixed feature space size n.

![](images/89bc878cd444d1b7e4b9f5e7698d6b453fdc2521c71e9e6a754f3e28a2fc88c1.jpg)

![](images/99ae04004f9cf2517ce41c452d90623be3ac1093b6b04c7d3d869f6c38c2e6d2.jpg)  
(b) Fixed device number m.   
...
![](images/59a32e4aec3233734c7ab386657144b85da5bbc4ad78a18e25533298c9bb4824.jpg)



(a) The probability $P r ( C o l _ { 1 } ^ { m } )$

![](images/049b4b9a255fc5d1bbfe04878f839ab2cdc3017de7d8ea328c40621fdee01188.jpg)
...
![](images/3a9d957bbe94e6a4c703262b2b902ce96d74ee4c507c3ba2bd0a04b6016b9f74.jpg)



(a) Uniform distribution, 2D bins

![](images/02f1b2fddb1649ee0bb5d18b5b17df242cf95087bc716fcc633acc5fab17db79.jpg)
...
![](images/6c93581e61becbd25d8ff056d9074d58751ed529fab529fb5b825daf1dfac1a2.jpg)



(a) Uniform distribution, 2D bins

![](images/ca16ad298e80b6494cc4db3ba85b7a666aaa40f96b16c91664f738e581db6e12.jpg)
...
Uniform distributed feature. In uniform distribution case, the probability that indistinguishable balls exist is ${ \cal P r } ( I _ { i } ^ { m } ) =$ $\begin{array} { r } { \mathrm { ~ 1 ~ - ~ } { P r } ( \neg I _ { i } ^ { m } ) \ = \ 1 - \ \binom { n } { m } m ! * \left( \frac { 1 } { \prod _ { i = 1 } ^ { k } n _ { i } } \right) ^ { m } } \end{array}$ Qki=1 ni , where $n =$ $\textstyle \prod _ { i = 1 } ^ { k } n _ { i }$ . The expected number of indistinguishable balls is $\begin{array} { r } { \bar { \mathbb { E } ( I ) } \bar { = } \frac { m ( m - 1 ) } { 2 \prod _ { i = 1 } ^ { k } n _ { i } } } \end{array}$ m(m−1) .
...
![](images/861fc6a3623e07805841ff793072b17454929e673db67f340563b95dd7b01052.jpg)



Fig. 6: Fingerprinting Fscore of the state-of-the-art method [10] in both static and dynamic scenario.

![](images/71c8781d4149b3079cb3f5074b1f79326ee8005d921bc82a17f2a67bfed38b7e.jpg)



Fig. 7: Fingerprinting Fscore of different models for different input data lengths in dynamic scenario.

![](images/97e1a228bc4994ec5309ea078e010fc471459382cefd5a9987b55c1983fe039b.jpg)
...
![](images/ccd419c8d8c1d04a2329e6f7a41a55cc814075889269c5bc4b884c2698e012de.jpg)



Fig. 9: Fingerprinting accuracy with Majority Voting.

![](images/0b58cdca1cb36a7fd066f2d247a828d19bad564a8af2d4829de433a220df66b5.jpg)
...
Using our large dataset collected from 117 diverse devices in real-life scenarios, we conduct comprehensive evaluation on our neural networks as well as the state-of-the-art methods [10]. We report detailed evaluation results and analysis in Section VII. As a summary, Fig. 7 shows the fingerprinting accuracy of our model compared with models in [10] for highly dynamic scenarios given different input data lengths w. It reveals that handcraft features based models (SVM and Random Forest) can only achieve $7 4 \% \sim 8 7 \%$ F-score due to the large noise caused by human activities. Our multi-LSTM approach achieves 93% F-score with only 1 second sensor data.

4) Majority Voting Strategy: To further increase the accuracy, we apply the Majority Voting Strategy: suppose a fingerprinting model for t-second input data has been trained to achieve an accuracy p. Then theoretically, given a piece of s × t-second data, where $s \in \mathbb { N }$ and $s > 1$ , by majority voting we can achieve the following accuracy:
...
![](images/5af35e8d33480b33942dd4418b8fe5ad8374a4530573e1318c001b09ed4c1958.jpg)
...
![](images/2fef28d8f4c6e4076ccf066ca20ce24e9532ac458c18bca7252c4c95c6c7ce00.jpg)



(a) Distribution in accelerometer dimension

![](images/e2c22b7a69eb944bd28257e4dffee2f731b684a53e1232a74c4528a766950c72.jpg)



(b) Distribution in gyroscope dimension

![](images/b68b757eae1938c314399c52f0cf0633f360c8c88f08238cd061292b63c881a9.jpg)



(c) Expectation number of indistinguishable devices

![](images/fc400dc9266241b4aa47514679410cd17e0cc96438512d6bcbf386f535e32661.jpg)
...
![](images/9c5c1028e07a7b381a663e1a8bca316d8459e22edc51cec8dcd844188e30d469.jpg)



Fig. 13: $L _ { 2 }$ distance and anonymization effect (measured by LSTM model).

![](images/f346f2b4958a372783beedfcef10490c1cac5d7e5236b16018c4a4c290c0d544.jpg)
