...
![](images/62e3db5fa65914d54adf5bec433179d8eb44af3d5eca988150ce451cc1ec6f43.jpg)



(b) Impact of the quantity of bMAVs

![](images/f01b4dbc82fbe45a330b32c5042afa877bef711e57cfd09a95c00e7e8a5cbf7d.jpg)
...
$$
\begin{array}{l} \binom {y _ {i, t + \delta} ^ {1}} {y _ {i, t + \delta} ^ {2}} = \binom {y _ {i, t} ^ {1}} {y _ {i, t} ^ {2}} + \delta \binom {v _ {i, t} ^ {1} + n _ {i, t} ^ {1}} {v _ {i, t} ^ {2} + n _ {i, t} ^ {2}}, (4) \\ n _ {i, t} ^ {1} \text {   is   drawn   from   } p (n ^ {1}), (4) \\ n _ {i, t} ^ {2} \text {   is   drawn   from   } p (n ^ {2}), \\ \end{array}
$$
