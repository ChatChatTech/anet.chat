...
https://www.usenix.org/conference/nsdi22/presentation/guo
...
![](images/a7c377d49092b9384621fb3f259010406d5a2dd1fd4c92b00d26d828d9878704.jpg)



(a) Traditional LoRa backscatter tag   
(b) Backscatter tag with demodulation ability   
...
![](images/c989dfc03308fd6fbdbaecf1c241052b9dbbb3beec9f8ec22af3b3599c59145d.jpg)
...
where A is the signal amplitude; $f ( t ) = F _ { 0 } +$ kt describes how the frequency of this chirp signal varies over time; $F _ { 0 }$ is the initial frequency offset; k is the frequency changing rate. The frequency of a LoRa chirp wraps to 0 right after peaking BW —the bandwidth of LoRa. Different LoRa chirps peak the frequency BW at different time due to the difference in their initial frequency offset, as shown in Figure 3(a). Applying a differential to a LoRa chirp, we have:

$$
\begin{array}{l} s ^ {\prime} (t) = \frac {d s (t)}{d t} = A c o s (2 \pi f (t) t) [ 2 \pi \frac {d f (t)}{d t} t + 2 \pi f (t) ] \tag {2} \\ = \underbrace {2 \pi A (F _ {0} + 2 k t)} _ {\text { Amplitude }} \cos (2 \pi f (t) t) \\ \end{array}
$$

The above equation indicates that the amplitude of the transformed signal $s ^ { \prime } ( t )$ is proportional to the frequency of the input LoRa chirp s(t), as shown in Figure 3(b). This frequencyamplitude correlation allows us to demodulate the frequencymodulated (FM) chirp signal by tracking the peak amplitude of its transformed amplitude-modulated (AM) counterpart.
...
![](images/5b353a8f0a3489d10cc34f62e8f69c6cfb54cdac3e879ef3ba21f46d4de90280.jpg)  
...
![](images/8ac4272fbb86b5094263d9a7c8d1a2caa6b5aebf434ec520776eb30de1ec5dff.jpg)
...
![](images/7ef7d3b007b7cfb02a711adbc3ad5e71f9e5449efbf25bda20008c8a142b3fc3.jpg)
...
$$
B _ {i} = \left\{ \begin{array}{l l l l l} \text { low }, & \text { if } & A _ {i} <   U _ {H} & \& & B _ {i - 1} = \text { low } \\ \text { high }, & \text { if } & A _ {i} \geq U _ {H} & \& & B _ {i - 1} = \text { low } \\ \text { low }, & \text { if } & A _ {i} <   U _ {L} & \& & B _ {i - 1} = \text { high } \\ \text { high }, & \text { if } & A _ {i} \geq U _ {L} & \& & B _ {i - 1} = \text { high } \end{array} \right. \tag {3}
$$
...
![](images/b84053dd709b184ace98ad55595e02d38abdf059466fd903bb3620b68a058c56.jpg)
...
![](images/28397eadc0eadad43c76c3f990c4f2f6560e52986ca8e9039ca3e503f0bdf62f.jpg)  
...
• Step 1. The micro-controller first generates a clock signal $C L K _ { i n } ( \Delta f )$ and mixes it with the incident signal $S ( F )$ , resulting in two sideband signals $S ( F - \Delta f )$ and $S ( F + \Delta f )$ , as shown in Figure 9(a)-(b). The sideband signals and the incident signal are then down-converted to the intermediate frequency (IF) band (denoted by $S ( - \Delta f )$ and $S ( \Delta f ) )$ and the baseband (denoted by $S ( 0 ) )$ respectively with an envelope detector (Figure 9(c)).

![](images/602b30102cf3e55358fa77ab52255c14180f7536ec2eab3cba3e040b9c99ae52.jpg)  
...
![](images/3a08a959c4e6caec67577b8136d2a95a56fc9e6814ea101eb9e1bb3a4e2e9b71.jpg)



(a) Without frequency shifting

![](images/54060f2dac5dac649e7c01c2633c8d1b55914a6ec4bca333c911cae8903baf84.jpg)
...
where ∆φ is the phase shift caused by the delay line. We tune the length of this delay line to ensure $c o s ( \Delta \Phi ) \approx 1$ so that $C L K _ { o u t } ( \Delta f )$ equals $C L K _ { i n } ( \Delta f )$ .
...
![](images/2aeb36f706ffa892dc6c34af6263f7db8a481f861964aac3ad44127fdcfefce6.jpg)



Figure 11: The schematic of cyclic-frequency shifting.   
![](images/5c35bf4757f2f2e96b7a8d5b9b7dd5ac2aa38dd5692076f942aa54d41b7df1d7.jpg)
...
![](images/4b75aa8b097eb444198a6c3a97184d80641dd316ef0ae776b13071a118d393f9.jpg)
...
![](images/b2df0fd9da3060fe0e75d13ebc0bdb1a7f5f09a56a8cc5a22f3f16afcecf152b.jpg)
...
![](images/3a701eda25c0a545c60a0a737cea9578034bd02d2f68888b9533c503f1b95483.jpg)
...
![](images/ae1acf822651997cf9dd416051cf352966af4410ba7107297b64fcfed9b7ef5e.jpg)



(a) BER

![](images/b8e639e48846631e945bb9ba7aeb0c24f58789841c2a973737f5d0312e3d9586.jpg)



(a) Range

![](images/7313cbf11c1245f93682e41609e9e29eb5b19db32416c10abb6645d5129fbc2e.jpg)



(a) Range

![](images/5959cf77b0c500c19cf3c60b8d5775bbde5648f74553ccf23d2728925e854678.jpg)



(b) Throughput

![](images/9f1f5bd6e9f2d233adac1794ce141b725dfe4154c0a2e97d1a3db833bbac09f2.jpg)



(b) Throughput

![](images/71020ca4bae563317a4fe7951cf50e84b98966d6baf8e3d94b4df8a6b3028e0d.jpg)
...
![](images/2fe8ace5062ec0aa65897d95b7218c71402f766049583b532d4e363b03fd898b.jpg)



Figure 19: Throughput and downlink range in the presence of one concrete wall.

![](images/601203e8b4910f8fefeae69d006a477f7b973b05a72cac8b7d6654dc250b8713.jpg)



Figure 20: Throughput and downlink range in the presence of two concrete walls.

![](images/76942512e46d60a7f26ad12d9c582c5a07f9402bd9652f4218a3993c2fd4d016.jpg)



Figure 21: Comparison of Saiyan, Aloba, and PLoRa on the detection range.

![](images/b4effac2f5e31994283df288c9c01e8b9e1ccc567ce9445c76c3d33176908f11.jpg)



Figure 22: RSS and BER over distance.

![](images/c8ff3f4fac5c7f166fbb9eaf655255e821f4432f5257989db58ccfd52254e8f8.jpg)



Figure 23: The amplitude gap of the output signal after SAW filter

![](images/05fccf8becb5137ffc88ee8c17532a575f6f219e8baf5ff073ae381f83ee55ad.jpg)
...
Figure 21 shows the experiment result. In the outdoor lineof-sight settings, Saiyan achieves a packet detection range of 148.6 m, outperforming ALoBa (30.6m) and PLoRa (42.4m) by 4.52× and 3.26×, respectively. In an indoor none-lineof-sight environment, although the packet detection range of Saiyan declines to 44.2 m, it still outperforms Aloba (12.4 m) and PLoRa (16.8 m) by 3.56× and 2.63×, respectively.
...
![](images/9dd8cc56b7d9e3f3e8662db2d2bdbec491f902bb993ff147f272828fee6900d5.jpg)



Figure 25: Ablation study of Saiyan.

![](images/4209af9c251946ce73223e50e1afd80e17ba61da782c8093902431e196d80268.jpg)



Figure 26: PRR in different settings.

![](images/9a179e111d8a35cb85c362e0f8f5ce0ed40158e6749ae3c28337b3da6be57a7b.jpg)
...
<table><tr><td>Component</td><td>SAW Filter</td><td>LNA</td><td>OSC Clock</td><td>Envelope Detector</td><td>Comparator</td><td>MCU</td><td>Total</td></tr><tr><td>Energy (μW)</td><td>0</td><td>248.5</td><td>86.8</td><td>0</td><td>14.45</td><td>19.6</td><td>369.4</td></tr><tr><td>Cost ($)</td><td>3.87</td><td>4.15</td><td>1.25</td><td>1.20</td><td>1.26</td><td>15.43</td><td>27.2</td></tr></table>
...
$$
Q = \sqrt {L} / (R \cdot \sqrt {C}) \tag {7}
$$

Given a constant center frequency of $\mathfrak { \omega } _ { 0 } = 1 / ( 2 \pi \sqrt { L C } )$ , we can deduce the capacitance C satisfy that:

$$
C = \frac {1}{Q \omega_ {0} R} = \frac {\Delta \omega}{\omega_ {0} ^ {2} R} \tag {8}
$$
